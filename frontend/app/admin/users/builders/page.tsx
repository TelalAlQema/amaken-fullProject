...
export default function AdminBuildersPage() {
  ...
  const handleStatusAction = (userId: number, action: string) => {
    ...
    const labels: Record<string, { title: string; message: string }> = {
      activate: {
        ...
        message: "Are you sure you want to activate this builder?",
      },
      deactivate: {
        title: "Deactivate Builder",
        message: "Are you sure you want to deactivate this builder?",
      },
      freeze: {
        title: "Freeze Builder",
        message: "Are you sure you want to freeze this builder?",
      },
      unfreeze: {
        title: "Unfreeze Builder",
        message: "Are you sure you want to unfreeze this builder?",
      },
    };
  ...
  const handleDelete = (userId: number) => {
    ...
    setConfirmAction({
      ...
      message:
        "This action cannot be undone. Are you sure you want to delete this builder?",
      danger: true,
    });
  };
