...
import type { RegisterEmail, ApiResponse } from "@amaken/shared";
import {
  Search,
  ChevronLeft,
  ChevronRight,
...
export default function RegisteredAccountsPage() {
  ...
  >({
    queryKey: ["admin-registered-accounts", page],
    queryFn: () =>
      api
        .get("/admin/accounts/registered", { params: { page, limit: 50 } })
        .then((r) => r.data),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ["admin-registered-accounts"],
      });
      setDeleteId(null);
    },
  });
  ...
  return (
    <div className="bg-gray-50 p-6 min-h-screen">
      <ConfirmDialog
        ...
        message="Are you sure you want to delete this account record? This action cannot be undone."
        onConfirm={() => {
